...
<div class="row">
    <div class="col-lg-12">
        <div class="d-flex justify-content-between mb-2">
            <div class="">
                <a href="@if(auth()->user()->role_id==\App\Models\User::ROLE_ADMIN) {{ route('admin.add-booking') }} @endif"  class="btn customBg text-white"><i class="fa fa-plus-circle mr-1"></i>Add booking</a>
                @if($selectedRows)
